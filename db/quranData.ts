const SURAH_DATA: Record<number, string> = {
  112: "قُلْ هُوَ ٱللَّهُ أَحَدٌ ١ ٱللَّهُ ٱلصَّمَدُ ٢ لَمْ يَلِدْ وَلَمْ يُولَدْ ٣ وَلَمْ يَكُن لَّهُۥ كُفُوًا أَحَدٌۢ ٤",
  113:
...
export function getSurahText(surah: number): string {
  return SURAH_DATA[surah] ?? "";
}
